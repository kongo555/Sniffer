...
public class RawUdpPacketSender {
    ...
    private void sendPacket(byte[] destinationAddress, int port, byte[] data)
        ...
        packet.order(ByteOrder.BIG_ENDIAN);// najbardziej znaczący bajt umieszczony jest jako pierwszy
    ...
    public static void main(String[] args) throws IOException {
        ...
        //byte[] data = createMagicPacket();
        byte[] data = new byte[1];
        URI destination = URI.create("udp://192.168.40.33:6006");
        sender.sendPacket(destination, data);
    }
